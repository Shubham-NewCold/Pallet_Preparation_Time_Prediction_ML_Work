...
class DataIngestionConfig:
    ...
    raw_data_path: str=os.path.join("artifacts","CaseStudy_2.csv") #all data will be saved in artifacts path
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            df = pd.read_csv(os.path.join('artifacts', 'CaseStudy_2.csv')
...
######################################################################
   ...
   #Final Scores are returned which we can print
    ...
    model_scores = model_trainer.initiate_model_trainer(train_df_final)
    logging.info("Model training completed. Final evaluation metrics:")
    logging.info(model_scores)

    # Validation Set Predictions
    model_trainer.predict_for_validation_set(test_df_final)
